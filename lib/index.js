import {
  ...
  // No need to import variousList since we'll just return their values anyway (it's there as a reference)
} from './lists';
...
const getOS = () => {
  ...
  if (firefoxOSList.includes(platform)) return 'Firefox OS';
